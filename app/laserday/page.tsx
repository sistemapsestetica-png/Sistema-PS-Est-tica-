...
const concernImages: Record<string, { src: string; tone: string }> = {
  ...
  "Textura ou poros aparentes": { src: "/quiz-concerns/pores.png", tone: "peach" },
...
export default function LaserDayPage() {
  ...
  return <main className={s.page}>
    ...
    <section className={s.how}><div className={s.sectionIntro}><p className={s.eyebrow}>Como funciona</p><h2>Do que você percebe na pele a uma decisão mais consciente</h2></div><ol><li><span>1</span><div><h3>Conte o que incomoda</h3><p>Quatro perguntas objetivas ajudam a organizar o que você gostaria de melhorar.</p></div></li><li><span>2</span><div><h3>Receba sua análise inicial</h3><p>Entenda se há possibilidades no Laser Day compatíveis com seu objetivo.</p></div></li><li><span>3</span><div><h3>Consulte a próxima data</h3><p>Veja os horários disponíveis ou converse com a equipe antes de decidir.</p></div></li></ol></section>
