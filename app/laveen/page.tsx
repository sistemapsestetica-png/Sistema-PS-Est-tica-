...
const concernImages: Record<string, string> = {
  "Manchas e marcas do sol": "/quiz-concerns/sunspots.png",
  "Poros aparentes": "/quiz-concerns/pores.png",
  "Textura irregular": "/quiz-concerns/texture.png",
  "Falta de viço": "/quiz-concerns/dullness.png",
  "Linhas finas": "/quiz-concerns/fine-lines.png",
};
...
export default function LavieenPage() {
  ...
  async function submitContact(event: FormEvent<HTMLFormElement>) {
    ...
    if (!await saveLead()) { setNotice("Não conseguimos registrar seus dados agora. Tente novamente ou fale com a equipe."); setLoading(false); return; }
    setStep(6);
    await loadSlots();
    setLoading(false);
  }
